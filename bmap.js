window.BMAP_AUTHENTIC_KEY = "WH1r6gyQnp9Q3sSqemqhZUer";
(function() {
	function aa(a) {
		throw a;
	}
					...
					if(e.f_ == o) {
						...
						e.getTilesUrl = function(b, d) {
							var e = b.x,
								...
								l = 1;
							this.map.Fx() && (l = 2);
							l = "customimage/tile?&x=" + e + "&y=" + k + "&z=" + d + "&udt=20161111&scale=" + l;
	...
	Vc.getTilesUrl = function(a, b, c) {
		...
		return(Tc[Math.abs(d + a) % Tc.length] + "?qt=tile&x=" + (d + "").replace(/-/gi, "M") + "&y=" + (a + "").replace(/-/gi, "M") + "&z=" + b + "&styles=" + c + "&scaler=" + e + (6 == x.ea.la ? "&color_dep=32&colors=50" : "") + "&udt=20161111").replace(/-(\d+)/gi, "M$1")
	};
	var La = new Rc("\u5730\u56fe", Vc, {
			tips: "\u663e\u793a\u666e\u901a\u5730\u56fe",
			maxZoom: 19

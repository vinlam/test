layui.define(["form", "jquery"], function(exports) {
	...
	Address.prototype.provinces = function(code) {
		//加载省数据
		var proHtml = '',
			that = this;
	...
	//加载市数据
	Address.prototype.citys = function(citys, code, areacode) {
		var cityHtml = '<option value="">请选择市</option>',
			that = this;
	...
	//加载县/区数据
	Address.prototype.areas = function(areas, code) {
		var areaHtml = '<option value="">请选择县/区</option>';
	...
	Address.prototype.data = function(codearr) {
		this.provinces(codearr);
	}
	
	Address.prototype.getSelect = function(){
		var selectObj = {},
		codearr = [],
		namearr = [];
